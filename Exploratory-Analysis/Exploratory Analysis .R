severe_weather <- read.csv("https://raw.githubusercontent.com/info-201a-au21/Final-Project/main/dataset/severe_weather.csv?token=GHSAT0AAAAAAB6RUHXGUBKEN5S5LORU4OQKZAIAYFA")
weather <- read.csv("../dataset/WeatherEvents_Jan2016-Dec2020.csv", stringsAsFactors = FALSE)
