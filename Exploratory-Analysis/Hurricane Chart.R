pacific <- read.csv("https://raw.githubusercontent.com/info-201a-au21/Final-Project/main/dataset/pacific.csv?token=GHSAT0AAAAAAB6RUHXGZYVU44DICCM57Y5AZAIAZBQ")
